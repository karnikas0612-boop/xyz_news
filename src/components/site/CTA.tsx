...
const CTA = () => (
  <section id="contact" className="bg-paper py-24 md:py-32">
    <div className="container">
      <div className="relative overflow-hidden bg-gradient-broadcast text-paper p-10 md:p-16 lg:p-20 shadow-broadcast">
        ...
        <div className="relative grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div className="lg:pl-12 lg:border-l border-paper/15">
